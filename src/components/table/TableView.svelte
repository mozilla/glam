...
<div style="border-bottom: var(--space-base) solid var(--cool-gray-100);">
  <div
    style=" margin-top: var(--space-2x); margin-bottom: var(--space-2x);
    padding-left: var(--space-4x); padding-right: var(--space-4x); ">
    <Pagination
      on:page={(evt) => {
    ...
    <thead>
      ...
      <Row header>
        <Cell
          ...
          freezeX
          size="max"
          tooltip="the {aggregationLevel === 'build_id' ? ' build id' : 'version'}
