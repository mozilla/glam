...
<App orientation="horizontal">
  <Toolbar transparent>
    <h1>Untitled Product Metrics App</h1>

    <div
      class="content-block"
      style="display: grid; grid-auto-flow: row; grid-row-gap: var(--space-2x);
      align-items: end; justify-content: end; justify-items: end;">
      <ButtonGroup>
