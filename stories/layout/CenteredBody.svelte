...
<App centered>
  <Toolbar>
    <h1>Untitled Data App</h1>
  </Toolbar>
  <Content centered>
    <ContentHeader>
      <div class="content-block">
        <ButtonGroup>
          <Button level="medium" compact>
            <Chart size="14" />
            buttons
          </Button>
          <Button level="medium" compact>
    ...
    <ContentBody>
      <div
        class="surface surface--depth--large surface--border-radius--1"
        style="height: 100%;">
        <div
          class="content-block"
          style="display: grid; align-items: center; width: max-content; margin:
          auto;">
          <h2 style="margin:0; margin-top: var(--space-base);">
            Some Compelling Graphs
            <Chart />
          </h2>
          <UsageMetricsContent />
        </div>
    ...
    <ContentFooter>
      <div class="content-block">UNTITLED DATA PROJECT INDUSTRIES, 2020.</div>
    </ContentFooter>
  </Content>
</App>
