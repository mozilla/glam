...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('version', 'os', 'build_id', 'process', 'metric', 'metric_key', 'client_agg_type'), name='desktop_release_unique_dimensions'),
        ),
        migrations.AddConstraint(
            model_name='desktopnightlyaggregation',
            constraint=models.UniqueConstraint(fields=('version', 'os', 'build_id', 'process', 'metric', 'metric_key', 'client_agg_type'), name='desktop_nightly_unique_dimensions'),
        ),
        migrations.AddConstraint(
            model_name='desktopbetaaggregation',
            constraint=models.UniqueConstraint(fields=('version', 'os', 'build_id', 'process', 'metric', 'metric_key', 'client_agg_type'), name='desktop_beta_unique_dimensions'),
        ),
    ]
