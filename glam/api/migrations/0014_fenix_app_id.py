...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='fenixaggregation',
            constraint=models.UniqueConstraint(fields=('app_id', 'channel', 'version', 'ping_type', 'os', 'build_id', 'metric', 'metric_type', 'metric_key', 'client_agg_type'), name='fenix_unique_dimensions'),
        ),
        migrations.RunSQL(
            [
